...
import ch.hsr.ifs.cute.templator.test.TemplatorSimpleTest;
import ch.hsr.ifs.cute.templator.test.TestHelper;
...
public class FindFirstAncestorByTypeTest extends TemplatorSimpleTest {
    ...
    public void testFindAncestorWithTypeICPPASTFunctionCallExpressionWithoutAngleBrackets() throws Exception {
        ...
        ICPPASTFunctionCallExpression foundCallExpression = ASTTools.findFirstAncestorByType(functionCallName,
    ...
    public void testFindAncestorWithTypeICPPASTFunctionDefinitionGoodCase() throws Exception {
        ...
        ICPPASTFunctionDefinition foundCallExpression = ASTTools.findFirstAncestorByType(functionCallName,
    ...
    public void testFindAncestorWithTypeICPPASTTemplateDeclarationWithMaxLevel4() throws Exception {
        ...
        ICPPASTTemplateDeclaration templateDeclaration = ASTTools.findFirstAncestorByType(barMethodName,
                ICPPASTTemplateDeclaration.class, 4);
