...
public class CuteTextMergeViewer extends TextMergeViewer {
	...
	protected void configureTextViewer(TextViewer textViewer) {
		...
		if(CuteCorePlugin.getDefault().getPreferenceStore().getBoolean(PreferenceConstants.SHOW_WHITESPACES)) {
	...
	private void logException(Exception e) {
		CuteCorePlugin.log(new Status(IStatus.ERROR, CuteCorePlugin.PLUGIN_ID,e.getMessage(), e));
