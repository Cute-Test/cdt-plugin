...
import ch.hsr.ifs.cute.core.model.ISessionListener;
...
public class TestRunnerViewPart extends ViewPart implements ISessionListener {
	...
	public TestRunnerViewPart() {
		super();
		CuteCorePlugin.getModel().addListener(this);		
	}
	...
	private final class SessionFinishedUIJob extends UIJob {
		...
		public IStatus runInUIThread(IProgressMonitor monitor) {
			...
			return new Status(IStatus.OK, CuteCorePlugin.PLUGIN_ID, IStatus.OK,"OK",null);
		}
	}
	...
	private class FailuresOnlyFilterAction extends Action {
		public FailuresOnlyFilterAction() {
			...
			setImageDescriptor(CuteCorePlugin.getImageDescriptor("obj16/failures.gif")); //$NON-NLS-1$
		}
	...
	private class RerunLastTestAction extends Action{
		public RerunLastTestAction() {
			...
			setDisabledImageDescriptor(CuteCorePlugin.getImageDescriptor("dlcl16/relaunch.gif")); //$NON-NLS-1$
			setHoverImageDescriptor(CuteCorePlugin.getImageDescriptor("obj16/relaunch.gif")); //$NON-NLS-1$
			setImageDescriptor(CuteCorePlugin.getImageDescriptor("obj16/relaunch.gif")); //$NON-NLS-1$
			setEnabled(false);
		}
	...
	private class StopAction extends Action{
		public StopAction() {
			...
			setDisabledImageDescriptor(CuteCorePlugin.getImageDescriptor("dlcl16/stop.gif")); //$NON-NLS-1$
			setHoverImageDescriptor(CuteCorePlugin.getImageDescriptor("obj16/stop.gif")); //$NON-NLS-1$
			setImageDescriptor(CuteCorePlugin.getImageDescriptor("obj16/stop.gif")); //$NON-NLS-1$
		}
