...
import ch.hsr.ifs.cute.core.model.ITestComposite;
import ch.hsr.ifs.cute.core.model.ITestCompositeListener;
import ch.hsr.ifs.cute.core.model.ITestElementListener;
import ch.hsr.ifs.cute.core.model.NotifyEvent;
...
public class CounterPanel extends Composite implements ITestElementListener, ISessionListener, ITestCompositeListener {
	...
	private Image errorImage = CuteCorePlugin.getImageDescriptor("tcr/error.gif").createImage();  //  @jve:decl-index=0:
	private Image failedImage = CuteCorePlugin.getImageDescriptor("tcr/failed.gif").createImage();  //  @jve:decl-index=0:
	...
	private void initialize() {
		...
		addDisposeListener(new DisposeListener() {
			public void widgetDisposed(DisposeEvent e) {
				disposeIcons();
				CuteCorePlugin.getModel().removeListener(CounterPanel.this);
			}
		});
