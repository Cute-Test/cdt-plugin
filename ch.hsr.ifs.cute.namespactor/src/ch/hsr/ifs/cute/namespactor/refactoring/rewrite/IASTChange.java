...
/**
 * Interface for changes that can be applied to an AST, e.g. remove, replace,
 * insert, etc.
 * 
...
public interface IASTChange {
     ...
     * @return New rewrite created by the change or null if no new rewrite was
     *         created.
     */
    ...
    /**
     * Return the change root, this is the root for the rewrite created by the
     * change.
     * 
