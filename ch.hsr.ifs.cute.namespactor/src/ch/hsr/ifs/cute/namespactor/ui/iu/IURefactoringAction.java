 ...
 * */
public class IURefactoringAction extends RefactoringAction {

	public IURefactoringAction(String label) {
		super(label);
	}
	...
	public void run(IShellProvider shellProvider, IWorkingCopy wc, ITextSelection selection) {
        ...
        IURefactoringRunner runner = new IURefactoringRunner(wc, selection, shellProvider, wc.getCProject());
        runner.run();
	}
