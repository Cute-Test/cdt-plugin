...
public class QUNRefactoringAction extends RefactoringAction {

	public QUNRefactoringAction(String label) {
		super(label);
	}
	...
	public void run(IShellProvider shellProvider, IWorkingCopy wc, ITextSelection selection) {
        ...
        QUNRefactoringRunner runner = new QUNRefactoringRunner(wc, selection, shellProvider, wc.getCProject());
        runner.run();
