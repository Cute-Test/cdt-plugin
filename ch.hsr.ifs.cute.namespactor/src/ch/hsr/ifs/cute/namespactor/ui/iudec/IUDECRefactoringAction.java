...
public class IUDECRefactoringAction extends RefactoringAction {

	public IUDECRefactoringAction(String label) {
		super(label);
	}
	...
	public void run(IShellProvider shellProvider, IWorkingCopy wc, ITextSelection selection) {
        ...
        IUDECRefactoringRunner runner = new IUDECRefactoringRunner(wc, selection, shellProvider, wc.getCProject());
        runner.run();
