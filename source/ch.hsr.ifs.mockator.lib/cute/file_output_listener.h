...
public:
	...
	file_output_listener(std::string const& testSuiteName) :
			Listener() {
		resultFile = boost::shared_ptr<xml_output_file>(
				new xml_output_file(testSuiteName));
	}
	...
	static const std::string TEST_RESULT_FILE_NAME;
};
}
