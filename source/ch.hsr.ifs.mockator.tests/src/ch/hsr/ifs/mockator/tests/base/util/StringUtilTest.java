...
public class StringUtilTest {
  ...
  public void joinListOfStrings() {
    ...
    String joinedPainters = StringUtil.join(famousPainters, ", ");
    assertEquals("Andy Warhol, Claude Monet, Pablo Picasso, Paul Gaguin, Wassily Kandinsky",
        joinedPainters);
  }

  @Test
  public void quoteString() {
    String toQuote = "Mockator";
    assertEquals("\"Mockator\"", StringUtil.quote(toQuote));
  }

  @Test
  public void unQuoteStringWithDoubleQuotes() {
    String toUnquote = "\"Mockator\"";
  ...
  public void capitalizeString() {
    String toCapitalize = "mockator";
    assertEquals("Mockator", StringUtil.capitalize(toCapitalize));
  }

  @Test
  public void pythonFormatWithKeyValue() {
    Map<String, Object> m = unorderedMap();
    m.put("key", "mockator");
    m.put("value", 123);
    assertEquals("The key 'mockator' has the value 123",
        StringUtil.pythonFormat("The key '%(key)s' has the value %(value)d", m));
  }
}
