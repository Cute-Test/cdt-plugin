...
public class DefaultCtorClassRegistryTest {
  ...
  public void classesWithAllDefaultCtors() {
    Set<Class<? extends Vehicle>> klasses = orderPreservingSet(Car.class, Plane.class);
    assertEquals(CollectionHelper.list(new Car(), new Plane()),
        new DefaultCtorClassRegistry<Vehicle>(klasses).createInstances());
  }
  ...
  public void oneNonDefaultCtorYieldsException() {
    ...
    @SuppressWarnings("unchecked")
    Set<Class<? extends Vehicle>> classes =
        orderPreservingSet(Car.class, Plane.class, Bicycle.class);
    new DefaultCtorClassRegistry<Vehicle>(classes).createInstances();
  }
  ...
  public void oneNotAccessibleClassYieldsException() {
    ...
    @SuppressWarnings("unchecked")
    Set<Class<? extends Vehicle>> classes = orderPreservingSet(Car.class, Plane.class, Bike.class);
    new DefaultCtorClassRegistry<Vehicle>(classes).createInstances();
  }
