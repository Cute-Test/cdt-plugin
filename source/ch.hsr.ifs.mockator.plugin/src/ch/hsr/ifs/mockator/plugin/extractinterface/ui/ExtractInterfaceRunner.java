...
class ExtractInterfaceRunner extends RefactoringRunner {
  ...
  public ExtractInterfaceRunner(ITextSelection selection, ICElement element, IShellProvider shell,
      ICProject cProject) {
  ...
  private ExtractInterfaceRefactoring createRefactoring() {
    ExtractInterfaceContext context =
        new ExtractInterfaceContext.ContextBuilder((ITranslationUnit) element, project,
