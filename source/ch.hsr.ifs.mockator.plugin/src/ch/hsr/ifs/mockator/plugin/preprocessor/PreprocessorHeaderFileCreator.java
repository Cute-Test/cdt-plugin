...
class PreprocessorHeaderFileCreator extends PreprocessorFileCreator {
  ...
  public PreprocessorHeaderFileCreator(ModificationCollector collector, ICProject cProject,
  ...
  private static void addIncludeGuardsEnd(IASTTranslationUnit header, ASTRewrite r,
      IncludeGuardCreator guardCreator) {
    r.insertBefore(header, null, guardCreator.createEndIf(), null);
  }

  private static void addIncludeGuardsStart(IASTTranslationUnit header, ASTRewrite r,
      IncludeGuardCreator guardCreator) {
    r.insertBefore(header, null, guardCreator.createIfNDef(), null);
    r.insertBefore(header, null, guardCreator.createDefine(), null);
  }

  private void insertFunDecl(ICPPASTFunctionDeclarator funDecl, IASTTranslationUnit newTu,
      ASTRewrite r) {
  ...
  private static void insertTraceMacro(ICPPASTFunctionDeclarator funDecl,
      IASTTranslationUnit header, ASTRewrite r) {
  ...
  private static void addMacroValue(ICPPASTFunctionDeclarator funDecl, StringBuilder define,
      String paramString) {
  ...
  private static String addMacroName(ICPPASTFunctionDeclarator funDecl, StringBuilder define,
      String paramString) {
  ...
  private void insertFunDeclInclude(ICPPASTFunctionDeclarator funDecl, IASTTranslationUnit tu,
      ASTRewrite rewriter) throws CoreException {
