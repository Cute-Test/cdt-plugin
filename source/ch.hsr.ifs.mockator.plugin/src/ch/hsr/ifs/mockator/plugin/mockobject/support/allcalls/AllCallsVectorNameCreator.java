...
public class AllCallsVectorNameCreator {
	...
	private ICPPASTQualifiedName createNewFqNameForAllCallsVector() {
		ICPPASTQualifiedName className = new QualifiedNameCreator(mockObject.getName()).createQualifiedName();
	...
	private static boolean isNameAlreadyExisting(IASTCompoundStatement funBody, final String allCallsVectorName) {
