...
enum ArgumentPassByStrategy {
  ...
  asPointer {
    ...
    public void adaptArguments(IASTName problemArg, String nameOfNewInstance, ASTRewrite rewriter) {
      ICPPASTConstructorInitializer ctorInit =
          AstUtil.getAncestorOfType(problemArg, ICPPASTConstructorInitializer.class);
      ICPPASTFunctionCallExpression funCall =
          AstUtil.getAncestorOfType(problemArg, ICPPASTFunctionCallExpression.class);
  ...
  asReference {
    @Override
    public void adaptArguments(IASTName problemArgument, String nameOfNewInstance,
        ASTRewrite rewriter) {
  ...
  public abstract void adaptArguments(IASTName problemArg, String nameOfNewInstance,
      ASTRewrite rewriter);

  private static void adaptFunCallArguments(String nameOfNewInstance, ASTRewrite rewriter,
      ICPPASTFunctionCallExpression funCall) {
    IASTInitializerClause[] argumentListWithAdaptedArgument =
        getArgumentListWithAdaptedArgument(funCall.getArguments(), nameOfNewInstance);
  ...
  private static void adaptCtorArguments(String nameOfNewInstance, ASTRewrite rewriter,
      ICPPASTConstructorInitializer ctorInitializer) {
    IASTInitializerClause[] argumentListWithAdaptedArgument =
        getArgumentListWithAdaptedArgument(ctorInitializer.getArguments(), nameOfNewInstance);
    ICPPASTConstructorInitializer initializer =
        nodeFactory.newConstructorInitializer(argumentListWithAdaptedArgument);
    rewriter.replace(ctorInitializer, initializer, null);
  }

  private static IASTInitializerClause[] getArgumentListWithAdaptedArgument(
      IASTInitializerClause[] arguments, String nameOfNewInstance) {
  ...
  public static ArgumentPassByStrategy fromName(String name) {
    ...
    if (strategy == null)
      throw new MockatorException(String.format("Unknown pass by strategy '%s'", name));
