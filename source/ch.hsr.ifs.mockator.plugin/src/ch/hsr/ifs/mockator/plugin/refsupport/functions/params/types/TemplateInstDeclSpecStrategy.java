...
class TemplateInstDeclSpecStrategy implements DeclSpecGeneratorStrategy {
   ...
   public ICPPASTDeclSpecifier createDeclSpec(IType type) {
      ...
      ParallelIterator<ICPPTemplateParameter, ICPPTemplateArgument> it = getParallelIt(templateInstance);
   ...
   private static boolean considerTemplateArgument(ICPPTemplateArgument defaultV, ICPPTemplateArgument templateArg) {
   ...
   private static ParallelIterator<ICPPTemplateParameter, ICPPTemplateArgument> getParallelIt(ICPPTemplateInstance ti) {
   ...
   private static Iterator<ICPPTemplateArgument> getTemplateArgIterator(ICPPTemplateInstance templateInstance) {
      return list(templateInstance.getTemplateArguments()).iterator();
   }

   private static Iterator<ICPPTemplateParameter> getTemplateParamIterator(ICPPTemplateDefinition templateDef) {
   ...
   private static IASTTypeId toASTTypeId(ICPPTemplateArgument templateArgument) {
      ...
      ICPPASTDeclarator newDeclarator = nodeFactory.newDeclarator(nodeFactory.newName(shortestType.toCharArray()));
