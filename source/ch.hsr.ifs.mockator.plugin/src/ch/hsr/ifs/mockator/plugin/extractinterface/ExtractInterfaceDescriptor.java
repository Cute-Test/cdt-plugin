...
public class ExtractInterfaceDescriptor extends CRefactoringDescriptor {
  ...
  public ExtractInterfaceDescriptor(String id, String project, String desc, String comment,
  ...
  private ExtractInterfaceContext createContext(RefactoringStatus status) throws CoreException {
    ...
    return new ExtractInterfaceContext.ContextBuilder(getTranslationUnit(), getCProject(),
        (ITextSelection) getSelection()).withRefactoringStatus(status)
