...
public class IncludeGuardCreator {
  ...
  public ASTLiteralNode createIfNDef() {
    return new ASTLiteralNode(MockatorConstants.IFNDEF_DIRECTIVE + MockatorConstants.SPACE
        + includeGuardSymbol);
  }

  public ASTLiteralNode createDefine() {
    return new ASTLiteralNode(MockatorConstants.DEFINE_DIRECTIVE + MockatorConstants.SPACE
        + includeGuardSymbol);
  }
  ...
  private int getIncludeGuardScheme() {
    int scheme =
        PreferenceConstants.getPreference(CODE_TEMPLATES_INCLUDE_GUARD_SCHEME, cProject,
