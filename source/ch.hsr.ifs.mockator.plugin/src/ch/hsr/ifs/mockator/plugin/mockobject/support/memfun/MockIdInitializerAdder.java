...
public class MockIdInitializerAdder implements F1V<ICPPASTFunctionDefinition> {
   ...
   public void apply(ICPPASTFunctionDefinition ctor) {
      ...
      ICPPASTConstructorChainInitializer ctorInitializer = getMockIdInitializer(nextCallIdReservation);
   ...
   private ICPPASTConstructorChainInitializer getMockIdInitializer(IASTInitializerClause nextCallIdReservation) {
