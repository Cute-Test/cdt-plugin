...
public class CppIncludeResolver {
  ...
  private static IIndexFile getIndexFile(String filePath, ICProject project, IIndex index)
      throws CoreException {
    return getIndexFile(IndexLocationFactory.getIFLExpensive(project, filePath), index);
  }

  private static IIndexFile getIndexFile(IIndexFileLocation fileLocation, IIndex index)
      throws CoreException {
