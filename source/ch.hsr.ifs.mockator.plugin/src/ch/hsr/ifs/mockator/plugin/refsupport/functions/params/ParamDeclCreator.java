...
public class ParamDeclCreator {
  ...
  public static ICPPASTParameterDeclaration createReferenceParamFrom(String typeName,
  ...
  public static ICPPASTParameterDeclaration createParameterFrom(IASTExpression idExpr,
      Map<String, Boolean> nameHistory) {
  ...
  public static ICPPASTParameterDeclaration createParameter(IType type,
      IASTInitializerClause clause, Map<String, Boolean> nameHistory) {
  ...
  public static ICPPASTParameterDeclaration createParameter(IASTIdExpression idExpr,
      Map<String, Boolean> nameHistory) {
  ...
  public static ICPPASTParameterDeclaration createParameter(IASTLiteralExpression litexpr,
      Map<String, Boolean> nameHistory) {
    ...
    IASTDeclarator declarator =
        getParameterDeclarator(paramName, litexpr.getExpressionType(), skipConstCharArray);
    makeLastPtrOpConst(declarator);
    return nodeFactory.newParameterDeclaration(spec, declarator);
  }

  public static ICPPASTParameterDeclaration createParameter(IASTFunctionCallExpression call,
      Map<String, Boolean> nameHistory) {
    IASTExpression functionName = call.getFunctionNameExpression();

    if (functionName instanceof IASTIdExpression) {
      ICPPASTParameterDeclaration paramDecl =
          createParameter((IASTIdExpression) functionName, nameHistory);
  ...
  private static IASTName getParmeterName(IASTInitializerClause clause,
      Map<String, Boolean> nameHistory) {
  ...
  private static IASTDeclarator getParameterDeclarator(IASTName parameterName, IType type,
      boolean skipConstCharArray) {
  ...
  private static IASTDeclarator assembleDeclarator(IASTName parameterName, IType type,
      boolean skipConstCharArray) {
  ...
  private static IASTDeclarator getPointerParameterDeclarator(IASTName parameterName,
      IPointerType type) {
