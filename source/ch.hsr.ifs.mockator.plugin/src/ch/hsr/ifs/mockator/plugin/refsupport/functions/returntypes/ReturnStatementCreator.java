...
public class ReturnStatementCreator {
  ...
  public IASTReturnStatement createReturnStatement(ICPPASTFunctionDeclarator funDecl,
      ICPPASTDeclSpecifier specifier) {
  ...
  private boolean isReferenceToThis(ICPPASTFunctionDeclarator funDecl,
      ICPPASTDeclSpecifier specifier) {
  ...
  private static IASTReturnStatement createDereferencedThisPointer() {
    ICPPASTLiteralExpression thisPtr =
        nodeFactory.newLiteralExpression(lk_string_literal, THIS_POINTER);
