...
public class PublicInheritanceAdder implements F1V<ExtractInterfaceContext> {
  ...
  private static ICPPASTBaseSpecifier createPublicBase(ICPPASTCompositeTypeSpecifier klass,
      IASTName newInterfaceName) {
  ...
  private static ICPPASTCompositeTypeSpecifier addInterfaceAsBaseClass(
      ICPPASTCompositeTypeSpecifier klass, ICPPASTBaseSpecifier base) {
    ICPPASTCompositeTypeSpecifier copy = klass.copy();
    copy.addBaseSpecifier(base);
    return copy;
  }

  private static void replaceOldClassWithNew(ExtractInterfaceContext context,
      ICPPASTCompositeTypeSpecifier oldClass, ICPPASTCompositeTypeSpecifier newClass) {
