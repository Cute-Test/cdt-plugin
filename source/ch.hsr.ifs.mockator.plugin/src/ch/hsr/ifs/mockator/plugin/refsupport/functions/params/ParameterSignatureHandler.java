...
public class ParameterSignatureHandler {
  ...
  private static String getParameterSignatureString(IASTParameterDeclaration parameterDeclaration) {
    return trimRight(appendParameterDeclarationString(new StringBuilder(), parameterDeclaration))
        .toString();
  }
  ...
  private static StringBuilder appendDeclarationString(StringBuilder buffer,
      IASTDeclSpecifier declSpecifier, IASTDeclarator declarator,
  ...
  private static StringBuilder appendDeclaratorString(StringBuilder buffer,
      IASTDeclarator declarator, boolean protectPointers, IASTFunctionDeclarator returnTypeOf) {
    if (declarator == null)
      return buffer;
    ...
    if (declarator != returnTypeOf) {
      ...
      if (nestedDeclarator != null) {
        ...
        appendDeclaratorString(buffer, nestedDeclarator, protectPointers, returnTypeOf);
          ...
          && ((ICPPASTDeclarator) declarator).declaresParameterPack()) {
  ...
  private static StringBuilder appendInitializerString(StringBuilder buffer,
    ...
    if (initializer instanceof IASTEqualsInitializer) {
      ...
      final ICPPASTConstructorInitializer constructorInitializer =
          (ICPPASTConstructorInitializer) initializer;
      ...
      throw new MockatorException("Not impplemented: " + initializer.getClass().getName());
    return buffer;
  }

  private static StringBuilder appendInitClauseString(StringBuilder buffer,
  ...
  private static StringBuilder appendArrayQualifiersString(StringBuilder buffer,
  ...
  private static StringBuilder appendPointerOperatorsString(StringBuilder buffer,
  ...
  private static StringBuilder appendParameterSignatureString(StringBuilder buffer,
      IASTFunctionDeclarator functionDeclarator) {
    if (functionDeclarator instanceof IASTStandardFunctionDeclarator) {
      final IASTStandardFunctionDeclarator standardFunctionDecl =
          (IASTStandardFunctionDeclarator) functionDeclarator;
      ...
      buffer.append(Keywords.cpLPAREN);
      final ICASTKnRFunctionDeclarator knrDeclarator =
          (ICASTKnRFunctionDeclarator) functionDeclarator;
      ...
      for (int i = 0; i < names.length; i++) {
        ...
        if (names[i] != null) {
          final IASTDeclarator declaratorForParameterName =
              knrDeclarator.getDeclaratorForParameterName(names[i]);
  ...
  private static StringBuilder appendParameterDeclarationString(StringBuilder buffer,
  ...
  public static StringBuilder appendDeclSpecifierString(StringBuilder builder,
    ...
    if (declSpecifier instanceof IASTCompositeTypeSpecifier) {
      final IASTCompositeTypeSpecifier compositeTypeSpec =
      ...
      final IASTElaboratedTypeSpecifier elaboratedTypeSpec =
          (IASTElaboratedTypeSpecifier) declSpecifier;
  ...
  private static StringBuilder appendNameString(StringBuilder buffer, IASTName name,
      boolean qualified) {
  ...
  private static StringBuilder appendExpressionString(StringBuilder buffer,
    ...
    if (expression instanceof ICPPASTSimpleTypeConstructorExpression) {
      final ICPPASTSimpleTypeConstructorExpression typeCast =
  ...
  private static StringBuilder appendArraySubscriptExpression(StringBuilder buffer,
  ...
  private static StringBuilder appendCastExpression(StringBuilder buffer,
      IASTCastExpression expression) {
  ...
  private static StringBuilder appendFieldReference(StringBuilder buffer,
      IASTFieldReference expression) {
  ...
  private static StringBuilder appendFunctionCallExpression(StringBuilder buffer,
  ...
  private static StringBuilder appendTypeIdInitializerExpression(StringBuilder buffer,
      ICASTTypeIdInitializerExpression expression) {
    buffer.append(Keywords.cpLPAREN);
    appendTypeIdString(buffer, expression.getTypeId());
    buffer.append(Keywords.cpRPAREN);
  ...
  private static StringBuilder appendDeleteExpression(StringBuilder buffer,
      ICPPASTDeleteExpression expression) {
  ...
  private static StringBuilder appendTypeIdExpression(StringBuilder buffer,
      IASTTypeIdExpression expression) {
  ...
  private static StringBuilder appendExpressionList(StringBuilder buffer,
      IASTExpressionList expression) {
  ...
  private static StringBuilder appendLiteralExpression(StringBuilder buffer,
      IASTLiteralExpression expression) {
    return buffer.append(expression.toString());
  }

  private static StringBuilder appendConditionalExpression(StringBuilder buffer,
      IASTConditionalExpression expression) {
  ...
  private static StringBuilder appendNewExpression(StringBuilder buffer,
      ICPPASTNewExpression expression) {
  ...
  private static StringBuilder appendBinaryExpression(StringBuilder buffer,
  ...
  private static StringBuilder appendUnaryExpression(StringBuilder buffer,
