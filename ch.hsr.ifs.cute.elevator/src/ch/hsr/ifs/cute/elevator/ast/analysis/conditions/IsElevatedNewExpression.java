...
public class IsElevatedNewExpression extends Condition {
    ...
    public boolean satifies(final IASTNode node) {
        ...
        return properties.hasAncestor(ICPPASTNewExpression.class) && properties.getAncestor(ICPPASTNewExpression.class).getInitializer() instanceof IASTInitializerList;
    }
