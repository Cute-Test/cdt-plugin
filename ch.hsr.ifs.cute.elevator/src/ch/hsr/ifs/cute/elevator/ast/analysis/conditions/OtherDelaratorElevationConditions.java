...
public class OtherDelaratorElevationConditions extends Condition {
    ...
    private boolean isPartOfTypedef() {
        return properties.hasAncestor(IASTSimpleDeclaration.class) && properties.getAncestor(IASTSimpleDeclaration.class).getDeclSpecifier().getStorageClass() == IASTDeclSpecifier.sc_typedef;
    }
