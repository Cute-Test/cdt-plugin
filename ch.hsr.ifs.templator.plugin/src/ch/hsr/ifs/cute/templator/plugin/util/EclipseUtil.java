...
public final class EclipseUtil {
	...
	public static void navigateToNode(IASTNode node) {
		...
		NavigateToNameUIJob navigateJob = new NavigateToNameUIJob("Navigating to node " + node.getRawSignature(), path,
				offset, length);
	...
	public static IASTTranslationUnit getASTFromIndex(final ITranslationUnit tu, IIndex index)
