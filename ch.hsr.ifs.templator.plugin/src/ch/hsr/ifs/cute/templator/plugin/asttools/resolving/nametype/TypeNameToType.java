...
public class TypeNameToType {
	...
	public TypeNameToType(IASTName typeName, ICPPSpecialization specialization,
			AbstractResolvedNameInfo currentContext) {
		super();
		this.typeName = typeName;
		setSpecialization(specialization);
		this.currentContext = currentContext;
	...
	public String toString() {
		return "typeName=" + typeName + ", specialization=" + specialization + ", type=" + type + ", currentContext="
				+ currentContext;
	}
