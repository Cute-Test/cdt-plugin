...
import ch.hsr.ifs.templator.plugin.view.ViewHelper;
import ch.hsr.ifs.templator.plugin.view.interfaces.IRectangleHoverListener;
import ch.hsr.ifs.templator.plugin.view.interfaces.ISubNameClickCallback;
import ch.hsr.ifs.templator.plugin.view.interfaces.ISubNameClickCallback.ClickAction;
import ch.hsr.ifs.templator.plugin.view.listeners.RectangleHoverListener;
import ch.hsr.ifs.templator.plugin.view.rendering.RectanglePaintListener;
