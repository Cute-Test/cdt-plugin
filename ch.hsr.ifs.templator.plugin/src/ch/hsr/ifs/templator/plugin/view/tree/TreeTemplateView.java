...
import ch.hsr.ifs.templator.plugin.handler.ViewOpener;
import ch.hsr.ifs.templator.plugin.view.components.GlobalToolBar;
import ch.hsr.ifs.templator.plugin.view.components.ScrollAnimator;
import ch.hsr.ifs.templator.plugin.view.interfaces.ITemplateView;
import ch.hsr.ifs.templator.plugin.view.interfaces.ITreeViewController;
import ch.hsr.ifs.templator.plugin.view.rendering.ConnectionRenderer;
