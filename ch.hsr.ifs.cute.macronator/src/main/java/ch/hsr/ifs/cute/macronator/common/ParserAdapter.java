...
public class ParserAdapter {
    ...
    public ParserAdapter(String code) {
    ...
    private IScanner createScanner(FileContent fileContent, ParserLanguage lang) {
        ...
        return new CPreprocessor(fileContent, scannerInfo, lang, new NullLogService(), configuration, IncludeFileContentProvider.getSavedFilesProvider());
    }
