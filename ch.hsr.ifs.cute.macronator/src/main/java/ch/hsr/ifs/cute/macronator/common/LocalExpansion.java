...
public class LocalExpansion {
    ...
    public String getExpansion() {
        ArrayList<IASTName> macroNames = new ArrayList<IASTName>();
        macroNames.add(macroExpansion.getMacroReference());
        macroNames.addAll(Arrays.asList(macroExpansion.getNestedMacroReferences()));
        MacroExpander expander = new MacroExpander(ILexerLog.NULL, createDictionary(macroNames.toArray(new IASTName[macroNames.size()])), null, new LexerOptions());
