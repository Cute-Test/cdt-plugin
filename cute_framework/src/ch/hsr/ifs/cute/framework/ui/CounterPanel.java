...
import ch.hsr.ifs.cute.framework.model.ITestElementListener;
import ch.hsr.ifs.cute.framework.model.NotifyEvent;
...
public class CounterPanel extends Composite implements ITestElementListener, ISessionListener, ITestCompositeListener {
	...
	private Image errorImage = CuteFrameworkPlugin.getImageDescriptor("tcr/error.gif").createImage();  //  @jve:decl-index=0:
	private Image failedImage = CuteFrameworkPlugin.getImageDescriptor("tcr/failed.gif").createImage();  //  @jve:decl-index=0:
