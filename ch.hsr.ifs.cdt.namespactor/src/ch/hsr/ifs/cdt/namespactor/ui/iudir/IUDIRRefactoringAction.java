 ...
 * @author Jules Weder
 * */
public class IUDIRRefactoringAction extends RefactoringAction {

	public IUDIRRefactoringAction(String label) {
		super(label);
	}
	...
	public void run(IShellProvider shellProvider, IWorkingCopy wc, ITextSelection selection) {
        ...
        IUDIRRefactoringRunner runner = new IUDIRRefactoringRunner(wc, selection, shellProvider, wc.getCProject());
        runner.run();
