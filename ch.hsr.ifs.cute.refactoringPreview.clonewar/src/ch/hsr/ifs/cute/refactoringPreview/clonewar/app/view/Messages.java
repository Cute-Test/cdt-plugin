...
/**
 * Messages for the clonewar application.
 * 
...
public final class Messages {
     ...
     */
    public static final String[] FUNCTION_SELECTION_TABLE_HEADINGS = {
            "Name of type", "Type before extraction", "Type after extraction" };

    /**
     * Headings of the selection table of the type transformation.
     */
    public static final String[] TYPE_SELECTION_TABLE_HEADINGS = new String[] {
            "Defaulting", FUNCTION_SELECTION_TABLE_HEADINGS[0],
