...
/**
 * Wizard page for type selection of the function transformation.
 * 
 * @author ythrier(at)hsr.ch
 */
public class ETTPFunctionSelectionWizardPage extends ETTPSelectionWizardPage {
     ...
     */
    @Override
    protected void createTableItem(Table table, TypeInformation type,
