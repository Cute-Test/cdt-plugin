...
import ch.hsr.ifs.cute.refactoringPreview.clonewar.app.transformation.util.namelookup.ParamNameLookupStrategy;
...
public class ParamTransformAction extends TransformAction {
    ...
    public void performTransform() {
        ICPPASTParameterDeclaration param = (ICPPASTParameterDeclaration) getNode()
                .getParent();
        param.setDeclSpecifier(getNodeFactory().createNamedTypeSpecifier(
                getTemplateName()));
    }
}
