...
import ch.hsr.ifs.cute.refactoringPreview.clonewar.app.transformation.util.namelookup.NameLookupStrategy;

/**
 * Base class for different kinds of transformation that are applicable to
 * types: <li>Named type in body</li> <li>Named type parameter</li> <li>Named
 * type return</li> <li>Simple type in body</li> <li>Simple type parameter</li>
 * <li>Simple type return</li> <li>Nested type of a template, cast, or similar</li>
 * 
