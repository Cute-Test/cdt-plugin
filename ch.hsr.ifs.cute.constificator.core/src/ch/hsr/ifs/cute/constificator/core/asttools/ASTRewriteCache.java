package ch.hsr.ifs.cute.constificator.core.asttools;
...
public class ASTRewriteCache {
	...
	public ASTRewriteCache(IIndex index) {
		this.index = index;
		this.astTranslationUnitCache = new HashMap<String, IASTTranslationUnit>();
		this.astRewriteCache = new HashMap<IASTTranslationUnit, ASTRewrite>(); 
	}
	
	public IASTTranslationUnit getASTTranslationUnit(ITranslationUnit translationUnit) {
		String fileLocation = translationUnit.getLocationURI().toString();
