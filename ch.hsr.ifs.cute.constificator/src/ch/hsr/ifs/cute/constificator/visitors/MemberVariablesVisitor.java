...
import ch.hsr.ifs.cute.constificator.checkers.MemberVariableChecker;
...
public class MemberVariablesVisitor extends ASTVisitor {

	private final MemberVariableChecker parent;

	public MemberVariablesVisitor(MemberVariableChecker parent) {
