...
public class ResizableComposite extends Composite {
	...
	public ResizableComposite(final Composite parent, final ITreeViewController controller, int style) {
		...
		this.horizontalArrow = new Cursor(parent.getDisplay(), SWT.CURSOR_SIZEWE);
		this.verticalArrow = new Cursor(parent.getDisplay(), SWT.CURSOR_SIZENS);
		this.diagonalArrow = new Cursor(parent.getDisplay(), SWT.CURSOR_SIZENWSE);
