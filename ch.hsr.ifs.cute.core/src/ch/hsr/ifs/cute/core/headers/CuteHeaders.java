...
public abstract class CuteHeaders implements Comparable<CuteHeaders> {
	...
	public CuteHeaders() {
		...
		if (fVersionNumber == null) {
			throw new RuntimeException("Missing CuteVersionNumber annotation on '" + getClass().getName() + "'.");
		}
	}
	...
	public int compareTo(CuteHeaders o) {
		if (fVersionNumber.major() != o.fVersionNumber.major()) {
			return o.fVersionNumber.major() - fVersionNumber.major();
		}

		if (fVersionNumber.minor() != o.fVersionNumber.minor()) {
			return o.fVersionNumber.minor() - fVersionNumber.minor();
		}
