...
public abstract class ConsoleEventParser {
   ...
   protected void throwLineParsingException(IRegion reg, String line, Exception e) {
      throw new RuntimeException("Failure parsing console event {<line=" + line + ">, <Reg=" + reg +
   ...
   protected Matcher matcherFor(Pattern pattern, String line) throws CoreException {
      ...
      if (!m.matches()) { throw new CoreException(new Status(IStatus.ERROR, TestFrameworkPlugin.PLUGIN_ID, 1, "Pattern don't match", null)); }
      return m;
   }
