...
import ch.hsr.ifs.cute.mockator.extractinterface.preconditions.ClassDefinitionLookup;
import ch.hsr.ifs.cute.mockator.extractinterface.preconditions.MemFunCollector;
