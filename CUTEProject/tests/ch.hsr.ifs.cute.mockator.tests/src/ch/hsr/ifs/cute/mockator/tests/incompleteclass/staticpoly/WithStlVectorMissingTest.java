...
public class WithStlVectorMissingTest extends CDTTestingCheckerTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertMarkerMessages(new String[] { "Necessary member function(s) not existing in class Mock" });
    }
}
