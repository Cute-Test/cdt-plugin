...
public class Cpp11StdActivator {
    ...
    private static void setOptionInConfig(final IConfiguration config, final IOption[] options, final IHoldsOptions optionHolder,
            final int optionType, final String[] newValues) throws BuildException {
