...
import ch.hsr.ifs.cute.mockator.testdouble.entities.DefaultConstructor;
...
public class ExpectationsHandler {
    ...
    private void insertNewExpectationVector(final Collection<? extends TestDoubleMemFun> newMemFunsForExpectations,
        ...
        new NewExpectationsInserter(testFun, context.getMockObject(), context.getCppStandard(), context.getRewriter(), context
                .getLinkedEditStrategy()).insertExpectations(newMemFunsForExpectations);
    }
