...
public class ItaniumMangledNameGenerator {
    ...
    private boolean isSubstitutionNecessary(final String typeStr) {
        if (typeStr.startsWith("std::basic_string") || typeStr.startsWith("std::basic_ostream<char") || typeStr.startsWith(
                "std::basic_istream<char") || typeStr.startsWith("std::basic_iostream<char") || typeStr.startsWith("std::allocator")) {
            return true;
        }
