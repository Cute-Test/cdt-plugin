...
import static ch.hsr.ifs.cute.mockator.refsupport.functions.FunctionEquivalenceVerifier.ConstStrategy.ConsiderConst;
import static ch.hsr.ifs.cute.mockator.refsupport.functions.FunctionEquivalenceVerifier.ConstStrategy.IgnoreConst;
...
import ch.hsr.ifs.cute.mockator.refsupport.finder.PublicMemFunFinder.Types;
...
public class MemFunCollector implements Consumer<ExtractInterfaceContext> {
    ...
    private static Collection<IASTDeclaration> getUsedMemFuns(final ExtractInterfaceContext context,
            final Collection<IASTDeclaration> publicMemFuns) {
