...
public class MockSupportAdder {
    ...
    private void createAllCallsSequenceVector() {
        new AllCallsVectorInserter(context.getMockObject().getKlass(), context.getMockObject().getParent(), context.getMockObject()
                .getAllCallsVector(), context.getCppStandard()).insert(context.getRewriter());
    }
