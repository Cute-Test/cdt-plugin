package ch.hsr.ifs.cute.charwars.commands;
	    ...
	    button.addSelectionListener(new SelectionAdapter() {
	      ...
	      public void widgetSelected(SelectionEvent e) {
	    	  ...
	    	  Preferences[] preferences = {
	    			  new ProjectScope(project).getNode(CodanCorePlugin.PLUGIN_ID),
	    	  ...
	    	  String paramsKey = "ch.hsr.ifs.cute.charwars.problems.CStringProblem.params";
	    	  System.out.println(prefService.get(paramsKey, null, preferences));
	    	  
	    	  String severityKey = "ch.hsr.ifs.cute.charwars.problems.CStringProblem";
