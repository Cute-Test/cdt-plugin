...
public class RefactoringFactory {
	public static Refactoring[] createRefactorings() {
		return new Refactoring[] {
			...
			new ComparisonRefactoring(Function.STRCHR, Function.FIND, new ArgMapping(Arg.ARG_1), EnumSet.of(Kind.Unmodified_String)),
			
			//wcschr(wstr,b) == NULL -> wstr.find(b) == std::wstring::npos
			new ComparisonRefactoring(Function.WCSCHR, Function.FIND, new ArgMapping(Arg.ARG_1), EnumSet.of(Kind.Unmodified_String)),
			...
			new ComparisonRefactoring(Function.STRPBRK, Function.FIND_FIRST_OF, new ArgMapping(Arg.ARG_1), EnumSet.of(Kind.Unmodified_String)),
			
			//wcspbrk(wstr,b) == NULL -> wstr.find_first_of(b) == std::wstring::npos
			new ComparisonRefactoring(Function.WCSPBRK, Function.FIND_FIRST_OF, new ArgMapping(Arg.ARG_1), EnumSet.of(Kind.Unmodified_String)),
			...
			new ComparisonRefactoring(Function.STRRCHR, Function.RFIND, new ArgMapping(Arg.ARG_1), EnumSet.of(Kind.Unmodified_String)),
						
			//strstr(str,b) == NULL -> str.find(b) == std::string::npos
			new ComparisonRefactoring(Function.STRSTR, Function.FIND, new ArgMapping(Arg.ARG_1), EnumSet.of(Kind.Unmodified_String)),
			
			//wcsstr(wstr,b) == NULL -> wstr.find(b) == std::wstring::npos
			new ComparisonRefactoring(Function.WCSSTR, Function.FIND, new ArgMapping(Arg.ARG_1), EnumSet.of(Kind.Unmodified_String)),
			...
			new ComparisonRefactoring(Function.STRCSPN, Function.FIND_FIRST_OF, new ArgMapping(Arg.ARG_1), EnumSet.of(Kind.Unmodified_String)),
						
			//strcspn(str+n, b) == strlen(str) -> str.find_first_of(b, n) == std::string::npos
			new ComparisonRefactoring(Function.STRCSPN, Function.FIND_FIRST_OF, new ArgMapping(Arg.ARG_1, Arg.OFF_0), EnumSet.of(Kind.Unmodified_String, Kind.Modified_String)),
							
			//strspn(str, b) == strlen(str) -> str.find_first_not_of(b) == std::string::npos
			new ComparisonRefactoring(Function.STRSPN, Function.FIND_FIRST_NOT_OF, new ArgMapping(Arg.ARG_1), EnumSet.of(Kind.Unmodified_String)),
						
			//strspn(str+n, b) == strlen(str) -> str.find_first_not_of(b, n) == std::string::npos
			new ComparisonRefactoring(Function.STRSPN, Function.FIND_FIRST_NOT_OF, new ArgMapping(Arg.ARG_1, Arg.OFF_0), EnumSet.of(Kind.Unmodified_String, Kind.Modified_String)),
						
			//memchr(str, ch, count) == NULL -> std::find(str.begin(), str.end(), ch) == str.end()
			new ComparisonRefactoring(Function.MEMCHR, Function.STD_FIND, new ArgMapping(Arg.BEGIN, Arg.END, Arg.ARG_1), EnumSet.of(Kind.Unmodified_String)),
			...
			new FunctionRefactoring(Function.MEMCPY, Function.REPLACE, new ArgMapping(Arg.OFF_0, Arg.ARG_2, Arg.ARG_1, Arg.ZERO, Arg.ARG_2), EnumSet.of(Kind.Unmodified_String, Kind.Modified_String)),
			
			//memmove(str+off, b, n) -> str.replace(off, n, b, 0, n)
			new FunctionRefactoring(Function.MEMMOVE, Function.REPLACE, new ArgMapping(Arg.OFF_0, Arg.ARG_2, Arg.ARG_1, Arg.ZERO, Arg.ARG_2), EnumSet.of(Kind.Unmodified_String, Kind.Modified_String)),
				
			//strcmp(str,b) -> str.compare(b)
			new FunctionRefactoring(Function.STRCMP, Function.COMPARE, new ArgMapping(Arg.ARG_1), EnumSet.of(Kind.Unmodified_String)),
			
			//wcscmp(wstr,b) -> wstr.compare(b)
			new FunctionRefactoring(Function.WCSCMP, Function.COMPARE, new ArgMapping(Arg.ARG_1), EnumSet.of(Kind.Unmodified_String)),
			...
			new FunctionRefactoring(Function.STRCPY, Function.REPLACE, new ArgMapping(Arg.OFF_0, Arg.NPOS, Arg.ARG_1), EnumSet.of(Kind.Unmodified_String, Kind.Modified_String)),
			
			//strncat(str, b, n) -> str.append(b, 0, n)
			new FunctionRefactoring(Function.STRNCAT, Function.APPEND, new ArgMapping(Arg.ARG_1, Arg.ZERO, Arg.ARG_2), EnumSet.of(Kind.Unmodified_String)),
			
			//strncpy(str+off, b, n) -> str.replace(off, n, b, 0, n)
			new FunctionRefactoring(Function.STRNCPY, Function.REPLACE, new ArgMapping(Arg.OFF_0, Arg.ARG_2, Arg.ARG_1, Arg.ZERO, Arg.ARG_2), EnumSet.of(Kind.Unmodified_String, Kind.Modified_String)),
			
			//alias: strchr(alias, b) -> str.find(b, alias) 
			new FunctionRefactoring(Function.STRCHR, Function.FIND, new ArgMapping(Arg.ARG_1, Arg.OFF_0), EnumSet.of(Kind.Modified_Alias)),
			
			//alias: strstr(alias, b) -> str.find(b, alias) 
			new FunctionRefactoring(Function.STRSTR, Function.FIND, new ArgMapping(Arg.ARG_1, Arg.OFF_0), EnumSet.of(Kind.Modified_Alias)),
			
			//alias: strpbrk(alias, b) -> str.find(b, alias)
			new FunctionRefactoring(Function.STRPBRK, Function.FIND_FIRST_OF, new ArgMapping(Arg.ARG_1, Arg.OFF_0), EnumSet.of(Kind.Modified_Alias)),
				
			//atof(str) -> stod(str)
			new FunctionRefactoring(Function.ATOF, Function.STOD, new ArgMapping(Arg.ARG_0), EnumSet.of(Kind.Unmodified_String)),
				
			//atoi(str) -> stoi(str)
			new FunctionRefactoring(Function.ATOI, Function.STOI, new ArgMapping(Arg.ARG_0), EnumSet.of(Kind.Unmodified_String)),
			
			//atol(str) -> stol(str)
			new FunctionRefactoring(Function.ATOL, Function.STOL, new ArgMapping(Arg.ARG_0), EnumSet.of(Kind.Unmodified_String)),
			
			//atoll(str) -> stoll(str)
			new FunctionRefactoring(Function.ATOLL, Function.STOLL, new ArgMapping(Arg.ARG_0), EnumSet.of(Kind.Unmodified_String)),
